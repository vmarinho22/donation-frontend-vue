<template>
  <linear-stepper :steps="steps" :on-finish="createDoctor" />
</template>
...
import DoctorInfo from '@/components/Forms/Doctor/DoctorInfo/DoctorInfo.vue'
...
async function createDoctor() {
  try {
    ...
    toast.success(t('pages.admin.doctors.create.success', { password: userParams.password }), {
      duration: 10000,
      pauseOnHover: true,
      dismissible: true
    })
